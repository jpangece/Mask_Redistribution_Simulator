...
void DrawInputUI()
{
    ...
    DrawString(major_city_string.c_str(), 
	       570, 215 + base_y, 
    ...
    DrawString(other_city_string.c_str(), 
	    570, 
	    295 + base_y, 
	    GLUT_BITMAP_HELVETICA_18);
...
void DrawInfectHistoryFunctionCurve(const _CITY &city_info, int y_origin, 
				    int y_end, int x_origin, 
				    int x_end)
{
...
void ShowDialog()
{
	...
	DrawMaskHistoryFunctionCurve(city_info, y_origin, 
				     y_end, x_origin, 
				     x_end);
	DrawInfectHistoryFunctionCurve(city_info, y_origin, 
				       y_end, x_origin, 
				       x_end);
        //text
	char inf_num_str[128];
