...
// - 0 refers to unselected
// - 1 refers to the major city selected
// - 2 refers to other cities selected
// - 3 refers to infected threshold selected
...
void MouseFuncInputValues(int button, int state, int x, int y)
{
    ...
    {
        if (x >= major_city_input_x1
	        && x <= major_city_input_x2
	        && y >= major_city_input_y1 + input_ui_base_y
	        && y <= major_city_input_y2 + input_ui_base_y)
        {
        ...
        else if (x >= other_city_input_x1
		    && x <= other_city_input_x2
		    && y >= other_city_input_y1 + input_ui_base_y
		    && y <= other_city_input_y2 + input_ui_base_y)
        {
	    ...
	    else if (x >= threshold_infection_percent_input_x1
	    	&& x <= threshold_infection_percent_input_x2
	    	&& y >= threshold_infection_percent_input_y1 + input_ui_base_y
	    	&& y <= threshold_infection_percent_input_y2 + input_ui_base_y)
	    {
        ...
        if (x >= ok_button_x1
	        && x <= ok_button_x2
	        && y >= ok_button_y1 + input_ui_base_y
